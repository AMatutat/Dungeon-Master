 ...
 *
 * <p>Use {@link #addXP(long)} to gain XP for the component. The {@link HealthSystem} will use this
 * to increase the amount of XP in this component if the associated entity has killed another entity
 * with an {@link XPComponent} by the amount of {@link #lootXP()} from the killed entity.
 *
 * <p>The {@link XPSystem} will check if the component has collected enough XP to reach the next
 * level using {@link #xpToNextCharacterLevel()} and will then update the character level and
 * trigger the {@link #levelUp()} callback function.
 *
