...
import core.Entity;
import core.entities.WorldItemBuilder;
 ...
 *
 * <p>The {@link WorldItemBuilder WorldItemBuilder} demonstrates how to create an item entity. You
 * can use the {@link WorldItemBuilder#buildWorldItem(Item)} method to create a new item-entity from
 * an {@link Item}.
 *
 * <p>The {@link WorldItemBuilder} will create an entity with a {@link ItemComponent}, {@link
 * core.components.PositionComponent}, {@link core.components.DrawComponent}, and {@link
 * InteractionComponent}. The {@link WorldItemBuilder} will configure the interaction-callback for
 * the item-entity so that if the player character interacts with it, the stored {@link Item} will
 * be added to the {@link InventoryComponent} of the player, and the item-entity will be removed
 * from the game.
 *
 * <p>By default, an {@link Item} that is dropped from the inventory will be (re-) created as an
 * item-entity using the {@link WorldItemBuilder}.
 *
