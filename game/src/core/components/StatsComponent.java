...
import core.utils.components.stats.DamageModifier;

/**
 * Add resistances and vulnerabilities for {@link DamageType}s to the associated entity.
 *
 ...
 * entity.
 *
 * <p>The modifier values are taken into account as multiplier by the {@link HealthSystem} when
