...
import core.components.ItemComponent;
import core.crafting.CraftingIngredient;
import core.crafting.CraftingResult;
import core.crafting.CraftingType;
 ...
 * Entity} in the world with the {@link ItemComponent} attached. Collecting an item will add it to
 * the inventory of the collector. To change this behavior, override the {@link #drop(Entity,
 * Point)} and {@link #collect(Entity, Entity)}.
 *
